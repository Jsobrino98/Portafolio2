...
public class Controlador {
    ...
    private void gestionarVideojuegos() {
        ...
        while (!volver) {
            ...
            switch (opcion) {
                case 1 -> vista.mostrarMensaje("Opción para agregar un nuevo videojuego seleccionada.");
                case 2 -> vista.mostrarMensaje("Opción para consultar un videojuego por ID seleccionada.");
                case 3 -> vista.mostrarMensaje("Opción para listar todos los videojuegos seleccionada.");
                case 4 -> vista.mostrarMensaje("Opción para actualizar un videojuego seleccionada.");
                case 5 -> vista.mostrarMensaje("Opción para eliminar un videojuego seleccionada.");
                case 0 -> volver = true;
                default -> vista.mostrarMensaje("Opción no válida. Intentar de nuevo.");
            }
        }
    ...
    private void mostrarInformes() {
        ...
        while (!volver) {
            ...
            switch (opcion) {
                ...
                case 4 -> vista.mostrarMensaje("Opción para listar videojuegos alquilados por un cliente seleccionada.");
